"""
Django settings for licensemgmt project.
...
SECRET_KEY = 'j$gfgi1x+)6tk17(z1%z0thf2ju_8=&q@o5s4op1dkbb0od6^p'
...
INSTALLED_APPS = [
    ...
    #'crispy_forms', # Why can't I import this??
...
WSGI_APPLICATION = 'licensemgmt.wsgi.application'
